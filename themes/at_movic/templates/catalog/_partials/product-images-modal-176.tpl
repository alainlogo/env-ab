  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <figure>
          <img class="js-modal-product-cover product-cover-modal" width="{$product.cover.bySize.large_default.width}" src="{$product.cover.bySize.large_default.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
