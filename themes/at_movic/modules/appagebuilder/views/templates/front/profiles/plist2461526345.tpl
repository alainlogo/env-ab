...
{hook h='displayLeoCompareButton' product=$product}
    ...
    <div class="product-meta">{if isset($product.category_name) && isset($product.id_category_default)}<div class="category-default">
{foreach from=Product::getProductCategoriesFull($product.id_product) item=cat}
        {if (($cat.id_category) == ($product.id_category_default))}
